...
export const DEFAULT_RULES = {
  ...
  freeEntry: "Email support@takethewall.com with the subject Free wall entry. Include your name, email address, public display name, and desired ad text (up to 120 characters) or URL. Do not email identity documents. The operator reviews entries in received order for content and eligibility. Each valid entry receives a placement and the next available counted number when processed; sending an email does not reserve a number. Paid activations may occur while an entry awaits review. Free entries have the same claim requirements and referral tracking as paid placements. Contact support if you have not received confirmation.",
